    ...
    <script>
        ...
        function CalculateGrandTotal() {
            ...
            InvoiceItemList.forEach((item) => {
                // Multiply the product price by its quantity
                let itemTotal = parseFloat(item['sale_price']) * parseFloat(item['qty']);
                Total += itemTotal;
            });
            ...
            // Calculate VAT based on the updated Total
            ...
            document.getElementById('payable').innerText = Math.round(Payable);
