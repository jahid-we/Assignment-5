...
<nav class="navbar fixed-top px-0 shadow-sm bg-white">
    <div class="container-fluid">
        ...
        <a class="navbar-brand" href="#">
            ...
            <img class="nav-logo  mx-2"  src="{{asset('images/rent.png')}}" alt="logo" width="50px"/>
        </a>
...
<div id="sideNavRef" class="side-nav-open">
    ...
    <a href="{{url("/adminDashboard")}}" class="side-bar-item">
    ...
    <a href="{{url('/rentalPage')}}" class="side-bar-item">
        ...
        <span class="side-bar-item-caption">Rentals Info</span>
    </a>
